    ...
    [
        {
            ...
            image: require("@/assets/Home/header_slide/Sustain.jpg"),
            monthPost: "October",
            dayPost: "02",
            timeRead: "1",
        ...
        transition: {
            ...
            <div class="post__row">
                <div @click="goPost(object.id)" :class="{ effectActive: object.active.value }"
                    ...
                    <div :class="{ show__content: object.active.value }" class="side__bar--right">
                        <div>
